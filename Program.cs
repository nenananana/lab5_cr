...
{
    /// <summary>
    /// Главный класс программы, обеспечивающий взаимодействие с пользователем
    /// и выполнение операций с базой данных и протоколированием.
    /// </summary>
    class Program
    {
        /// <summary>
        /// Точка входа в программу.
        /// Предлагает пользователю выбрать режим протоколирования, а затем
        /// предоставляет меню для работы с базой данных: просмотр, добавление,
        /// редактирование, удаление элементов, а также выполнение запросов.
        /// </summary>
