...
{
    /// <summary>
    /// Представляет картину с идентификатором, названием, ссылками на 
    /// художника и стиль, а также дополнительной информацией.
    /// </summary>
    class Painting
    {
        private int _id;
        ...
        /// <param name="ermitagePart">Часть Эрмитажа, 
        /// в которой находится картина.</param>
        /// <param name="year">Год создания картины.</param>
        /// <param name="idStyle">Идентификатор стиля картины.</param>
        public Painting(int id, string name, int idArtist, 
            int ermitagePart, int year, int idStyle)
        {
            _id = id;
            _name = name;
            _idArtist = idArtist;
        ...
        /// </summary>
        public int ErmitagePart 
        { 
            get => _ermitagePart;
            set => _ermitagePart = value;
        }
        ...
        public override string ToString() =>
            $"id = {_id}, name = {_name}, idArtist = {_idArtist}, " +
            $"ermitagePart = {_ermitagePart}, year = {_year}, idStyle = {_idStyle}";
    }
}
